...
This file lives in compat/ because it belongs to the legacy runtime.
The canonical replacement is the structured FactRecord/EntityRecord
persistence in mempalace/infrastructure/storage/sqlite_catalog.py.
